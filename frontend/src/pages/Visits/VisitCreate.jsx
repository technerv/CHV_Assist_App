...
const VisitCreate = () => {
  ...
  const [formData, setFormData] = useState({ chv: '', household: '', member: '', visit_date: new Date().toISOString().slice(0, 16), channel: 'app', purpose: '', observations: '', follow_up_required: false });
  ...
  return (
    <Container maxWidth="md">
      <Paper sx={{ p: 4 }}>
        <Typography variant="h4" fontWeight={700} gutterBottom>Record New Visit</Typography>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}><Box display="flex" gap={2}><Button type="submit" variant="contained">Record Visit</Button><Button variant="outlined" onClick={() => navigate('/visits')}>Cancel</Button></Box></Grid>
          </Grid>
        </form>
      </Paper>
    </Container>
