...
const HouseholdCreate = () => {
  ...
  return (
    <Container maxWidth="md">
      <Paper sx={{ p: 4 }}>
        <Typography variant="h4" fontWeight={700} gutterBottom>Add New Household</Typography>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}><Box display="flex" gap={2}><Button type="submit" variant="contained">Create Household</Button><Button variant="outlined" onClick={() => navigate('/households')}>Cancel</Button></Box></Grid>
          </Grid>
        </form>
      </Paper>
    </Container>
