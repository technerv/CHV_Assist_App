...
const ReferralCreate = () => {
  ...
  return (
    <Container maxWidth="md">
      <Paper sx={{ p: 4 }}>
        <Typography variant="h4" fontWeight={700} gutterBottom>Create New Referral</Typography>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}><Box display="flex" gap={2}><Button type="submit" variant="contained">Create Referral</Button><Button variant="outlined" onClick={() => navigate('/referrals')}>Cancel</Button></Box></Grid>
          </Grid>
        </form>
      </Paper>
    </Container>
